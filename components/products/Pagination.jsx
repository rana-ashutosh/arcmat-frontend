...
export default function Pagination({ totalPages, totalItems }) {
  const { currentPage, setCurrentPage, itemsPerPage } = useUIStore();
            ...
            {visiblePages.map((page, idx) => (
              <button
                ...
                className={clsx(
                  ...
                  page === currentPage
                    ? 'z-10 bg-[#d9a88a] text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#d9a88a]'
